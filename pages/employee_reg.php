...
if($obj->if_match($_SESSION['userType'],"accounting")):$ei = $employee_id; endif;
	...
	if($pdo->existData(TABLE,array('employee_id'=>$ei))==true AND $employee_id == $ei
		...
		if($obj->if_match($_SESSION['userType'],"hr")){
			$params = array('name'=>$form['name'],'employee_id'=>$form['employee_id'],'gender'=>$form['gender'],'birthdate'=>$form['birthdate'],'address'=>$form['address'],'designation'=>$form['designation'],'hire'=>$form['hire']);
		}else if($obj->if_match($_SESSION['userType'],"accounting")){
...
?>
<body background="theme/img/background.jpeg">
<div class="row" style="max-width: 400px; margin: 0 auto 10px; " >
<h4 class="ui block header" style="max-width: 500px; margin: 0 auto 10px; ">
<div class="row" style="max-width: 350px; margin: 0 auto 10px;" > 
<h2 class="ui header"> <center>
  <img src="theme/img/add.png" height="70" class="ui circular image">
</h4>	
...
<?php if($_SESSION['userType']=="hr"): ?>
		...
		<!---- max="2015-01-01" max="1900-01-01" -->
			<input type="date" name="birthdate" class="form-control" value="<?php if(isset($birthdate))echo $birthdate; ?>" >
		</div>
		...
		<div class="form-group">
		 <label for="hire">Date Hire</label>
			<input type="date" name="hire" class="form-control" value="<?php if(isset($hire))echo $hire; ?>" >
		</div>
...
<?php if($_SESSION['userType']=="accounting"): ?>
			...
			<label for="salary">Salary</label>
				<div class="input-group">
					<span class="input-group-addon">&#8369;</span>
						<input name="salary" type="number" min="0" max="500000" class="form-control" placeholder="" value="<?php if(isset($salary))echo $salary; ?>" maxlength="7" required>
		...
		<div class="form-group">
			<label for="tax">Tax</label>
				<div class="input-group">
					<span class="input-group-addon">&#8369;</span>
						<input name="tax" type="number" min="0" max="500000" class="form-control" placeholder="" value="<?php if(isset($tax))echo $tax; ?>" maxlength="7" required>
					<span class="input-group-addon">.00</span>
				</div>
		</div>		
		<div class="form-group">
			<label for="sss">SSS</label>
				<div class="input-group">
					<span class="input-group-addon">&#8369;</span>
						<input name="sss" type="number"  min="0" max="500000" class="form-control" placeholder="" value="<?php if(isset($sss))echo $sss; ?>" maxlength="7" required>
					<span class="input-group-addon">.00</span>
				</div>
		</div>
		<div class="form-group">
			<label for="pag_ibig">PAG-IBIG</label>
				<div class="input-group">
					<span class="input-group-addon">&#8369;</span>
						<input name="pag_ibig" type="number" min="0" max="500000" class="form-control" placeholder="" value="<?php if(isset($pag_ibig))echo $pag_ibig; ?>" maxlength="7" required>
					<span class="input-group-addon">.00</span>
				</div>
		</div>
		<div class="form-group">
			<label for="philhealth">PHIL-HEALTH</label>
				<div class="input-group">
					<span class="input-group-addon">&#8369;</span>
						<input name="philhealth" type="number"  min="0" max="500000" class="form-control" placeholder="" value="<?php if(isset($philhealth))echo $philhealth; ?>" maxlength="7" required>
					<span class="input-group-addon">.00</span>
				</div>
		</div>
		<div class="form-group">
			<label for="sss_loan">SSS LOAN</label>
				<div class="input-group">
					<span class="input-group-addon">&#8369;</span>
						<input name="sss_loan" type="number" min="0" max="500000" class="form-control" placeholder="" value="<?php if(isset($sss_loan))echo $sss_loan; ?>" maxlength="7" required>
					<span class="input-group-addon">.00</span>
				</div>
		</div>
		<div class="form-group">
			<label for="pag_ibig_loan">PAG IBIG LOAN</label>
				<div class="input-group">
					<span class="input-group-addon">&#8369;</span>
						<input name="pag_ibig_loan" type="number" min="0" max="500000" class="form-control" placeholder="" value="<?php if(isset($pag_ibig_loan))echo $pag_ibig_loan; ?>" maxlength="7" required>
					<span class="input-group-addon">.00</span>
				</div>
		</div>
		<div class="form-group">
			<label for="company_loan">COMPANY LOAN</label>
				<div class="input-group">
					<span class="input-group-addon">&#8369;</span>
						<input name="company_loan" type="number" min="0" max="500000" class="form-control" placeholder="" value="<?php if(isset($company_loan))echo $company_loan; ?>" maxlength="7" required>
					<span class="input-group-addon">.00</span>
				</div>
		</div>
<?php endif; ?>	

<?php	if($_SESSION['userType']!="superadmin"): require_once('config/buttonform.php'); endif;	?>
	</form>
</div>
<?php
template_footer(); 